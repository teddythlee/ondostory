...
export default async function IdeasPage({ searchParams }: { searchParams: Promise<{ shared?: string; share?: string; edit?: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <IdeasManager initial={ideas} sharedImages={sharedImages} shareFailed={shareFailed} sharedEditId={sharedEditId} />
      </main>
    </div>
  )
}
